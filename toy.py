...
G = nx.erdos_renyi_graph(30, 0.12)  # 30 users with 12% connection probability
...
def simulate_with_trajectories(G, states, steps=15):
    ...
    plt.savefig("network_snapshots_labeled.png", dpi=300, bbox_inches="tight")
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig("diffusion_trajectories.png", dpi=300)
    plt.show()
